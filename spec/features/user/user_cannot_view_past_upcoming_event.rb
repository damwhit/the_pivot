...
RSpec.feature "UserCannotViewPastUpcomingEvent", type: :feature do
  include SpecHelpers
  scenario "user views events by category" do
    ...
    upcoming_past_event = make_events[:upcoming_past_event]
    ...
    expect(page).to_not have_content(upcoming_past_event.name)
  end
end
